package com.goranm.earthquakeapp.Activities;
...
import com.goranm.earthquakeapp.R;
import com.goranm.earthquakeapp.UI.CustomInfoWindow;
import com.goranm.earthquakeapp.model.EarthQuake;
import com.goranm.earthquakeapp.util.Constants;
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = 0;i<Constants.LIMIT;i++){
                                ...
                                //add circle to markers that have mag>>
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (Build.VERSION.SDK_INT < 23) {
            ...
            if(ContextCompat.checkSelfPermission(this,
                ...
                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_ORANGE)).title("Hello"));
                        ...
                        try {
                            ...
                            if(response.has("tectonicSummary") && response.getString("tectonicSummary")!=null){
                                ...
                                if (tectonic.has("text")&&tectonic.getString("text")!=null){
                                    ...
                                    htmlPop.loadDataWithBaseURL(null,text,"text/html","UTF8",null);
                                }
                            }
